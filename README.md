...
プロパティには private set アクセサーやバッキングフィールドを使用する。
...
プロパティには簡単のために private set アクセサーを使う。  
ただしプロパティの戻り値の型に System.Serializable 属性がついているときは、UnityEngine.SerializeReference 属性がついたバッキングフィールドを使う。
...
```csharp
    ...
    // U に System.Serializable 属性がついているときは、UnityEngine.SerializeReference 属性のバッキングフィールドを使用する。
    public U Property => field2;
    [UnityEngine.SerializeReference] private U field2;
